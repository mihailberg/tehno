...
$APPLICATION->IncludeFile(SITE_TEMPLATE_PATH."/include/cycle.php", array("CAPTION_TYPE"=>"BG"));
$APPLICATION->IncludeFile(SITE_TEMPLATE_PATH."/include/cycle.php",array("CAPTION_TYPE"=>"BG", "CAPTION_NAME"=>"Товары со скидкой", "SALES"=>true));
