...
<?$APPLICATION->IncludeComponent("bitrix:news", "news", Array(
    ...
    "DETAIL_PAGER_TITLE" => "Статьи",	// Название категорий
    "DETAIL_PAGER_TEMPLATE" => "arrows",	// Название шаблона
    "DETAIL_PAGER_SHOW_ALL" => "N",	// Показывать ссылку "Все"
    "DISPLAY_TOP_PAGER" => "N",	// Выводить над списком
    "DISPLAY_BOTTOM_PAGER" => "Y",	// Выводить под списком
    "SECTION_DISPLAY_BOTTOM_PAGER" => "N",	// Выводить под списком
    "CATEGORIES_H1" =>  "Cтатьи, обзоры и инструкции",
    "CATEGORIES_H2" =>  "Выберите раздел",
    "PAGE_CHAIN" => "Статьи",
